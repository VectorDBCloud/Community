...
4. [Ephemeral Context Protocol (ECP)](#ephemeral-context-protocol-ecp)
...
* **[ECP](https://github.com/VectorDBCloud/ecp)**: The official repository for the Ephemeral Context Protocol specification, schema, and reference implementations.

## Troubleshooting

If you encounter any issues while using Vector Database Cloud or participating in our community:

1. Check our [FAQ](/VectorDBCloud/Community/blob/main/link-to-faq) for common questions and answers.
